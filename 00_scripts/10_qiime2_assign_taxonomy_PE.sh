...
######  --input-path /Users/pierre-louisstenger/Documents/PostDoc_02_MetaBarcoding_IAC/02_Data/07_plastocor_nc_in_situ/plastocor_nc_in_situ/98_database_files/silva_nr99_v138_wSpecies_train_set.fa \
